...
def fetch_optimizer(args, model):
    ...
    scheduler = optim.lr_scheduler.OneCycleLR(
        optimizer,
        [args.lr / 2.0, args.lr / 2.0, args.lr / 2.0, args.lr],
        args.total_step + 100,
        pct_start=0.01,
...
@hydra.main(version_base=None, config_path="config", config_name="train_transparent2")
def main(cfg):
    set_seed(cfg.seed)
    ...
    booster_size = (480, 640)

    val_dataset = datasets.EurekaV1Dataset(
