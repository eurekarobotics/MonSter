...
@hydra.main(version_base=None, config_path="config", config_name="train_mixed2")
def main(cfg):
    set_seed(cfg.seed)
    ...
    state_dict = dinov2_vitl14.state_dict()
    model.mono_encoder.load_state_dict(state_dict, strict=True)
